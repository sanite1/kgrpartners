  ...
  return (
    <main>
      <PageMeta
        ...
        description="Moving people and goods on pure sunshine. Electric buses and tricycles built and charged in Kaduna on 800kW DC of our own off-grid solar power, since 2017."
      />
      <HomeHero />
      <ServicesSection />
      <BentoSection />
