...
export const CONTACT_CHANNELS: ContactChannel[] = [
  { label: "EMAIL US", value: "info@kgrpartners.com", icon: "Mail" },
  { label: "CALL US", value: "+234 800 000 0000", icon: "Phone" },
  { label: "VISIT THE DEPOT", value: "Kaduna, Nigeria", icon: "MapPin" },
];
